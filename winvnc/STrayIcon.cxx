...
public:
	STrayIcon(STrayIconThread& t)
		...
		, vncConnect(_T("XVncServer.exe"), _T("-noconsole -connect")) 
	{
		// ***
	...
	virtual LRESULT processMessage(UINT msg, WPARAM wParam, LPARAM lParam) 
	{
		...
		case WM_COMMAND:
			...
			case ID_DISCONNECT:
				...
				break;
			case ID_CLOSE:
				if (MsgBox(0, _T("Are you sure you want to close the server?"), MB_ICONQUESTION | MB_YESNO | MB_DEFBUTTON2) == IDYES) 
				{
					thread.server.stop();
					PostQuitMessage(0);
				}
